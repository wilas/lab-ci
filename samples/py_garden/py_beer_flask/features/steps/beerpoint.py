...
def step(context):
    assert re.search('beer point name: \w+', context.page.data)
...
def step(context,type):
    # print repr(context.page.data)
    # print repr(type)
    assert type in context.page.data.decode('utf-8')
...
def step(context,text):
    ...
    beerslist = BeautifulSoup(context.page.data).findAll('li')
    context.beerslist = []
